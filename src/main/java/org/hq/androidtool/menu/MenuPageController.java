...
import org.hq.androidtool.device.DeviceData;
import javafx.application.Platform;
import org.hq.androidtool.gui.GuiMainController;

public class MenuPageController {
    @FXML private TextField lblAndroidId;
    @FXML private Label lblAndroidVersion;
    @FXML private TextField lblDisplay;
    @FXML private TextField lblIp;
    @FXML private TextField lblMac;
    @FXML private Label lblManufacturer;
    @FXML private Label lblModel;
    @FXML private TextField lblProcessor;
    @FXML private TextField lblRam;
    @FXML private TextField lblSerial;
    @FXML private Label lblSimContract;
    @FXML private ProgressBar pgbStorage;
    @FXML private Label lblStorage;
    @FXML private Label lblStorageProgress;
    ...
    public MenuPageController(Device device, GuiMainController guiMainController){
        this.device = device;
